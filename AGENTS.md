...
Design and runtime constraints live in `docs/SEED.md`. Architecture is in `docs/ARCHITECTURE.md`. Spec files are under `docs/spec/`; fixtures under `docs/fixtures/`.

## Development loop

Read `PRINCIPLES.md`, `docs/SEED.md`, `docs/ARCHITECTURE.md`, and `DEVELOPING.md` before coding work, answering queries or giving advice.
